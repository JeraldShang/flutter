...
abstract final class Colors {
  ///Custom App Colors
  static const Color brand_tan = Color(0xFFF9F6EE);
  static const Color brand_red = Color(0xFFCC0000);
  static const Color brand_lightred = Color(0x35FF0000);
  static const Color brand_yellow = Color(0xFFFFBF00);
  static const Color brand_grey = Color(0xFFD9D9D9);
